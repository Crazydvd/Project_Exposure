Shader "Unlit/OrbFX"
{
	Properties
	{
		...
		_Offset("Offset", Range(0, 100)) = 1.0
		...
		SubShader
		{
			...
			Pass
			{
				...
				fixed _Fresnel, _FresnelWidth, _Distort, _IntersectionThreshold, _ScrollSpeedU, _ScrollSpeedV, _Amplitude, _Speed, _Offset;

				v2f vert(appdata v)
				{
					v2f o;
					v.vertex = v.vertex + v.normal * sin(_Time.y * _Speed + _Offset) * _Amplitude;
